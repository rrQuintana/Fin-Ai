...
const [confirmationCode, setConfirmationCode] = useState('');
  ...
  return (
    <SafeAreaView className="bg-gray-400 flex-1 items-center justify-center">
      <View className="flex bg-finai rounded-t-3xl p-4 w-screen h-screen mt-32 items-center justify-start">
        ...
        <TextInput
          ...
          className="bg-finai w-80 h-14 border-b-2 border-white text-center text-white text-lg rounded-xl my-10 px-4"
